...
function createCalendar(calendar, element, adjuster) {
    ...
    function AddSidebar() {
        ...
        for (var i = 0; i < months.length - 3; i++) {
            ...
            if (i == 0) {
                ...
                x.innerHTML += '<img src="./images/left.png" alt="">';
                ...
                x.innerHTML += '<img src="./images/right.png" alt="">';
            } else {
                if (i < 4) {
                    x.className += ' cld-pre';
                } else if (i > 4) {
    ...
    function AddDateTime() {
        ...
        if (calendar.Options.NavShow && !calendar.Options.NavVertical) {
            ...
            rwd.innerHTML = '<img src="./images/left.png" alt="">';
        ...
        if (calendar.Options.NavShow && !calendar.Options.NavVertical) {
            ...
            fwd.innerHTML = '<img src="./images/right.png" alt="">';
    ...
    days.forEach(value => {
        ...
        value.onclick = function () {
            ...
            window.location.href =  urlLesson+'?date_time='+calendar.Selected.Year+'-'+(calendar.Selected.Month + 1<10?'0'+(calendar.Selected.Month+1):(calendar.Selected.Month+1))+'-'+(parseInt(value.textContent)<10?'0'+parseInt(value.textContent):parseInt(value.textContent))
                +'&trainer_id='+$('select[name="trainer_id"]').val();
